...
&ensp;&ensp;&ensp;&ensp;(_b_) **_st_** (preceded by a valid **_st_**\-ending, itself preceded by at least 3 (_c_) **_et_** (preceded by a valid **_et_**\-ending, itself not preceded any of **_geordn_**, **_intern_**, **_plan_**, **_tick_** or **_tr_**).
