...
Put initial **_y_**, **_y_** after a vowel, and **_i_** between vowels into upper case. _R1_ and _R2_ (see the [note](r1r2.qmd) on _R1_ and _R2_) are then defined as in German.  
